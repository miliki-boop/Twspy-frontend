        ...
        <div className="w-3/5 mx-auto">
          ...
          <form>
            <div className="relative mt-10">
              ...
              />
              <button className="absolute right-0 top-0 bottom-0 px-4 py-2 bg-gray-200 text-gray-600 rounded-r" onClick={(event)=>{event.preventDefault(); sendDataToPHPApp('http://localhost:9000/select.php',inputValue);}}>
